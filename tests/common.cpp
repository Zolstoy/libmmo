...
//         std::string some_txt                 = std::format("\033[38;2;100;20;200m{:10.3f}\033[39;49m",
//         elapsed.count()); dest.append(some_txt.data(), some_txt.data() + some_txt.size());
//     }
...
//     auto now       = std::chrono::steady_clock::now();
//     formatter->add_flag<elapsed_formatter_flag>('*', now);
//     formatter->add_flag<thread_formatter_flag>('+');
