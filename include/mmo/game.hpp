...
{
   public:
    email_confirm(std::string const &smtp_username, std::string const &smtp_password, std::string const &smtp_url)
    {}
...
template <Persistence P>
class nickname_password
{
   private:
    P &persistence_;

   public:
    nickname_password(P &persistence)
